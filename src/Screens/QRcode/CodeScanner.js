    ...
    const onSuccess = (event) => {
        if (!scanned) {
            ...
            Linking.openURL(event.nativeEvent.codeStringValue)
                .catch(err => Alert.alert('Invalid QR Code'));
        }
    ...
    return (
        <View style={styles.container}>
            <View style={styles.Header_view}>
                ...
                <Image source={require('../../Assets/logo_zimo.png')} tintColor="white" style={{ marginLeft: moderateScale(40), width: moderateScale(61), height: moderateVerticalScale(50), }} />
