                ...
                <ImageBackground source={item.bgimg} style={styles.bgImg} >
                    <View >
                        ...
                        <View style={styles.iconView}>
                            <Image source={item.forwardicon} style={{ tintColor: 'white', width: moderateScale(19), height: moderateVerticalScale(19), }} />
                            <Image source={item.favicon} style={{ tintColor: '#B00000', marginHorizontal: moderateScale(21), width: moderateScale(21), height: moderateVerticalScale(19), }} />
                        </View>
                    </View>
